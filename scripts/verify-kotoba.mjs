...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("search bounded-index Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("search Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("search Wasm main mismatch");

console.log("search: bounded index+weights Web/Wasm conformance passed");
